...
/** Extract `content[0].text` from an Anthropic response. */
 ...
 */
export const AI_PROVIDERS: ProviderRegistry = {
  anthropic: {
    id: 'anthropic',
    name: 'Anthropic',
    ...
    formatResponse: (data) => anthropicContent(data)
  },
  openai: {
    id: 'openai',
    name: 'OpenAI',
    ...
    formatResponse: (data) => openaiContent(data)
  },
  xai: {
    id: 'xai',
    name: 'xAI',
